...
the Cornell Library. 
<<<<<<< Updated upstream
%Parts of the book are really frustrating. Some sections have turned into whole series of papers. The introduction is fantastic, the  first chapter is pretty good, and it goes downhill from there. 
=======
%Parts of the book are really frustrating. Some sections  have turned into whole series of papers. The introduction is fantastic, the  first chapter is pretty good, and it goes downhill from there. 
>>>>>>> Stashed changes
...
\begin{theorem_}[Berkovich, Thuillier, Loeser-Hrushovski]
