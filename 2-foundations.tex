...
\subsection{Absolute values and field extensions}\label{sec:abs-val-field-ext}
...
\end{align*}
Standard Grobner basis theory is the special case where $\Gamma=0$ and 
...
[Gr\"obner bases for fields with valuation---see Chan and MacLagan's paper 
``Gr\"obner bases over fields with valuations.'']
